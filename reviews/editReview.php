        ...
        <form class="w3-container w3-card w3-theme-d3" action="editReview.php" method="post" style="max-width:600px; margin:auto;">
            ...
            <select class="w3-select" name="review_id" required>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<option value='".$row['review_id']."'>#".$row['review_id']." - ".substr($row['comment'], 0, 30)."...</option>";
                }
                ?>
            </select><br>
            ...
            <p><button class="w3-button w3-cyan w3-round-large" type="submit" name="submit">Update</button></p>
        </form>
