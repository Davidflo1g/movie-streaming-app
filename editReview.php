    ...
    <div class="w3-container w3-padding-32">
        ...
        <form class="w3-container w3-card w3-theme-d3" action="editReview.php" method="POST" style="max-width:600px; margin:auto;">
            ...
            <select class="w3-select" name="review_id" required>
                ...
                <?php
                // FIX: use review_text instead of comment
                $sql = "
            ...
            <input class="w3-input w3-border" type="number" min="1" max="5" name="rating" required>
            ...
            <p>
                <button class="w3-button w3-cyan w3-round-large" type="submit" name="submit">
                    Update Review
                </button>
            </p>
        </form>
