    ...
    <div class="w3-container w3-padding-32">
        ...
        <form class="w3-container w3-card w3-theme-d3" action="deleteReview.php" method="POST" style="max-width:600px; margin:auto;">
            ...
            <select class="w3-select" name="review_id" required>
                ...
                <?php
                // FIX: Get review text + movie title + review id
                $sql = "
            ...
            <p>
                <button class="w3-button w3-red w3-round-large" type="submit" name="submit">
                    Delete Review
                </button>
            </p>
        </form>
        ...
        <div class="w3-container w3-padding">
            ...
            if (isset($_POST['submit'])) {
                ...
                // Secure prepared DELETE
                $sql = "DELETE FROM reviews WHERE review_id = ?";
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("i", $review_id);

                if ($stmt->execute()) {
                    echo "<div class='w3-panel w3-green w3-padding'>
                            Review deleted successfully!
                          </div>";
                } else {
                    echo "<div class='w3-panel w3-red w3-padding'>
                            Error: " . htc($conn->error) . "
                          </div>";
                }
            }
            ?>
